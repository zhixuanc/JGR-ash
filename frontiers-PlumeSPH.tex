...
AP took the lead to initialize the project. ZC carried out the Plume-SPH simulations, PUFF simulations, results analysis. MB carried out the HYSPLIT simulation and took the lead to improve the manuscript quality. QY post processed the PUFF simulation results, overlapped the simulation results with satellite observation. All authors contributed equally to the manuscript wrtiting.
