...
The most commonly used distribution in Puff is Poisson distribution. For the Poisson plume shape, the vertical height of ash particles is given by Eq. (\ref{eq:Poisson-plume-shape}):
\begin{equation}
...
Another commonly used vertical ash distribution in VATD simulation is Suzuki. For the Suzuki plume shape \citep{suzuki1983theoretical}, the ash mass vertical distribution is assumed to follow the equation (Eq. (\ref{eq:Suzuki-plume-shape})):
\begin{equation}
