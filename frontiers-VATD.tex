...
It is useful to compare the maximum cloud height in
Fig. \ref{fig:Plume-SPH-Puff-ash-cloud-max-height} with the wind field
indicated in HYSPLIT forward trajectory tracking (Fig. \ref{fig:hysplit-1624-utc}).  The comparison reveals that
