...
\tiny
 \keyFont{ \section{Keywords:} VATD, volcano, ash cloud, 3D plume model, initial conditions, numerical simulation, SPH, Pinatubo, ash transport, ash dispersal} %All article types: you may provide up to 8 keywords; at least 5 are mandatory.
\end{abstract}

\section{Introduction}

%\subsection{Volcanic Ash Transport Forecast}
...
% xx need to be a bit more specific in this section, discussing nuances a bit more thoroughly, rather than just discussing the high-concentration areas.  Look at figures while rewriting. xx
